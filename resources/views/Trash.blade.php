...
<body>
    ...
    <a href="javascript:void(0);" class="btn btn-danger delBtn" onclick='delBtn("restore","User")'>Restore</a>
    <a href="javascript:void(0);" class="btn btn-danger delBtn" onclick="delBtn('delete','User')">Delete</a>
